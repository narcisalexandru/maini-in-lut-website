  ...
  <div class="maini-ui__section md:px-4">
    ...
    <div class="maini-ui__container-products">
      ...
      <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <template v-else>
            <ul class="space-y-6">
              ...
              >
                  ...
                  <div class="flex flex-wrap items-center gap-3 mt-2">
                    <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                      ...
                      <input
                        ...
                        type="number"
                        min="1"
                        class="w-12 h-8 text-center border-x border-gray-300 text-sm focus:outline-none focus:ring-0"
                ...
                <div class="flex sm:flex-col sm:items-end justify-between sm:justify-start gap-2">
                  <button
                    type="button"
        ...
        >
          <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 sticky top-4 min-w-0 overflow-hidden">
            ...
            <dl class="space-y-2 mb-4">
              ...
              <div class="flex justify-between text-lg font-bold h-color-lunar-green pt-2 border-t border-gray-200">
                <dt>{{ t("total") }}</dt>
                <dd>{{ total }} RON</dd>
              </div>
            </dl>
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
              ...
              <div class="flex gap-2 min-w-0">
                <input
                  ...
                  class="min-w-0 flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#8a9772]/30 focus:border-[#8a9772]"
                />
                <button
                  type="button"

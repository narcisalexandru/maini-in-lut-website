import{s as y}from"./sjEzoH4c.js";import{s as A}from"./B-FIFkRO.js";import P from"./18RfqR8j.js";import k from"./5MTU_nRB.js";import _ from"./BbWnvMSJ.js";import{s as I}from"./C8vTVB2U.js";import{H as C,Y as s,U as v,c as f,o as d,W as x,F as w,v as S,z as l,w as u,b as g,y as B,s as b,Z as p,t as N}from"./BG0I7BMR.js";import"./D7MfS3S_.js";import"./Be1fzYNM.js";import"./CfmLXlSH.js";import"./BPHsYKlM.js";import"./DsI1fMEX.js";import"./DmfvTtO6.js";var H=({dt:e})=>`
.p-accordionpanel {
    display: flex;
...
`,D={root:"p-accordion p-component"},E=C.extend({name:"accordion",style:H,classes:D}),z={name:"BaseAccordion",extends:I,props:{value:{type:[String,Number,Array],default:void 0},multiple:{type:Boolean,default:!1},lazy:{type:Boolean,default:!1},tabindex:{type:Number,default:0},selectOnFocus:{type:Boolean,default:!1},expandIcon:{type:String,default:void 0},collapseIcon:{type:String,default:void 0},activeIndex:{type:[Number,Array],default:null}},style:E,provide:function(){return{$pcAccordion:this,$parentInstance:this}}},F={name:"Accordion",extends:z,inheritAttrs:!1,emits:["update:value","update:activeIndex","tab-open","tab-close","tab-click"],data:function(){return{d_value:this.value}},watch:{value:function(o){this.d_value=o},activeIndex:{immediate:!0,handler:function(o){this.hasAccordionTab&&(this.d_value=this.multiple?o==null?void 0:o.map(String):o==null?void 0:o.toString())}}},methods:{isItemActive:function(o){var r;return this.multiple?(r=this.d_value)===null||r===void 0?void 0:r.includes(o):this.d_value===o},updateValue:function(o){var r,t=this.isItemActive(o);this.multiple?t?this.d_value=this.d_value.filter(function(i){return i!==o}):this.d_value?this.d_value.push(o):this.d_value=[o]:this.d_value=t?null:o,this.$emit("update:value",this.d_value),this.$emit("update:activeIndex",this.multiple?(r=this.d_value)===null||r===void 0?void 0:r.map(Number):Number(this.d_value)),this.$emit(t?"tab-close":"tab-open",{originalEvent:void 0,index:Number(o)})},isAccordionTab:function(o){return o.type.name==="AccordionTab"},getTabProp:function(o,r){return o.props?o.props[r]:void 0},getKey:function(o,r){return this.getTabProp(o,"header")||r},getHeaderPT:function(o,r){var t=this;return{root:s({onClick:function(a){return t.onTabClick(a,r)}},this.getTabProp(o,"headerProps"),this.getTabPT(o,"header",r)),toggleicon:s(this.getTabProp(o,"headeractionprops"),this.getTabPT(o,"headeraction",r))}},getContentPT:function(o,r){return{root:s(this.getTabProp(o,"contentProps"),this.getTabPT(o,"toggleablecontent",r)),transition:this.getTabPT(o,"transition",r),content:this.getTabPT(o,"content",r)}},getTabPT:function(o,r,t){var i=this.tabs.length,a={props:o.props||{},parent:{instance:this,props:this.$props,state:this.$data},context:{index:t,count:i,first:t===0,last:t===i-1,active:this.isItemActive("".concat(t))}};return s(this.ptm("accordiontab.".concat(r),a),this.ptmo(this.getTabProp(o,"pt"),r,a))},onTabClick:function(o,r){this.$emit("tab-click",{originalEvent:o,index:r})}},computed:{tabs:function(){var o=this;return this.$slots.default().reduce(function(r,t){return o.isAccordionTab(t)?r.push(t):t.children&&t.children instanceof Array&&t.children.forEach(function(i){o.isAccordionTab(i)&&r.push(i)}),r},[])},hasAccordionTab:function(){return this.tabs.length}},components:{AccordionPanel:_,AccordionHeader:k,AccordionContent:P,ChevronUpIcon:A,ChevronRightIcon:y}};function K(e,o,r,t,i,a){var m=v("AccordionHeader"),$=v("AccordionContent"),T=v("AccordionPanel");return d(),f("div",s({class:e.cx("root")},e.ptmi("root")),[a.hasAccordionTab?(d(!0),f(w,{key:0},S(a.tabs,function(n,c){return d(),l(T,{key:a.getKey(n,c),value:"".concat(c),pt:{root:a.getTabPT(n,"root",c)},disabled:a.getTabProp(n,"disabled")},{default:u(function(){return[g(m,{class:B(a.getTabProp(n,"headerClass")),pt:a.getHeaderPT(n,c)},{toggleicon:u(function(h){return[h.active?(d(),l(p(e.$slots.collapseicon?e.$slots.collapseicon:e.collapseIcon?"span":"ChevronDownIcon"),s({key:0,class:[e.collapseIcon,h.class],"aria-hidden":"true",ref_for:!0},a.getTabPT(n,"headericon",c)),null,16,["class"])):(d(),l(p(e.$slots.expandicon?e.$slots.expandicon:e.expandIcon?"span":"ChevronUpIcon"),s({key:1,class:[e.expandIcon,h.class],"aria-hidden":"true",ref_for:!0},a.getTabPT(n,"headericon",c)),null,16,["class"]))]}),default:u(function(){return[n.children&&n.children.headericon?(d(),l(p(n.children.headericon),{key:0,isTabActive:a.isItemActive("".concat(c)),active:a.isItemActive("".concat(c)),index:c},null,8,["isTabActive","active","index"])):b("",!0),n.props&&n.props.header?(d(),f("span",s({key:1,ref_for:!0},a.getTabPT(n,"headertitle",c)),N(n.props.header),17)):b("",!0),n.children&&n.children.header?(d(),l(p(n.children.header),{key:2})):b("",!0)]}),_:2},1032,["class","pt"]),g($,{pt:a.getContentPT(n,c)},{default:u(function(){return[(d(),l(p(n)))]}),_:2},1032,["pt"])]}),_:2},1032,["value","pt","disabled"])}),128)):x(e.$slots,"default",{key:1})],16)}F.render=K;export{F as default};
